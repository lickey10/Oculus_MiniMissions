...
GUILayer, GUIText, and UnityEngine.UI.Image:

The recommended way for drawing 2D content is through SteamVR_Overlay.  There is an example of how to set this up
in the example scene.  GUIText and UnityEngine.UI.Image use their Transform to determine where they are drawn, so these
