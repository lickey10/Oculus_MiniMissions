...
public class DoneLaserSwitchDeactivation : MonoBehaviour
{
    ...
    private bool laserDeactivated = false;
	...
	void OnTriggerStay (Collider other)
	{
		...
		if(other.transform.root.gameObject == player && !laserDeactivated)
			// ... and the switch button is pressed...
			//if(Input.GetButton("Switch") || OVRInput.GetDown(OVRInput.Button.PrimaryIndexTrigger))
