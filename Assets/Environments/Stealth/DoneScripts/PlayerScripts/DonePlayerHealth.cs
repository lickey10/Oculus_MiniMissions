...
public class DonePlayerHealth : MonoBehaviour
{
    ...
    public GameObject StartLocation;                       // The location the character starts and resets to
	...
	void PlayerDead ()
	{
		...
		if(anim && anim.GetCurrentAnimatorStateInfo(0).nameHash == hash.dyingState)
	...
	void LevelReset ()
	{
        ...
        if (timer >= resetAfterDeathTime)
        {
            ...
            transform.root.position = StartLocation.transform.position;
        }
	}
